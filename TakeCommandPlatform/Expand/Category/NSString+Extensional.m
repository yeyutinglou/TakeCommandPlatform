        ...
        if (isForSurname)
        {
            ...
            for (NSString* tempPolyphoneSurname in allPolyphoneSurname)
            {
                if ([convertString hasPrefix:tempPolyphoneSurname])
                {
                    ...
                    NSString* rightPinYin = [arrayOfPolyphoneSurnamePinYinWithYinDiao objectWithIndex:0];
                    NSString* wrongPinYin = [arrayOfPolyphoneSurnamePinYinWithYinDiao objectWithIndex:1];
        ...
        if (isForSurname)
        {
            ...
            for (NSString* tempPolyphoneSurname in allPolyphoneSurname)
            {
                if ([convertString hasPrefix:tempPolyphoneSurname])
                {
                    ...
                    NSString* rightPinYin = [arrayOfPolyphoneSurnamePinYin objectWithIndex:0];
                    NSString* wrongPinYin = [arrayOfPolyphoneSurnamePinYin objectWithIndex:1];
                    NSRange rangeOfPinYin = NSMakeRange(0, wrongPinYin.length);
                    if ([[resultString substringWithRange:rangeOfPinYin] isEqualToString:wrongPinYin])
                    {
                        [resultString replaceCharactersInRange:rangeOfPinYin withString:rightPinYin];
